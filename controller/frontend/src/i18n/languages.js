...
// masing-masing bahasa. Bahasa yang belum punya kamus lengkap otomatis
// jatuh ke bahasa default (Inggris) — lihat src/i18n/locales.js.
//
// `rtl: true` menandai bahasa kanan-ke-kiri (arah dokumen di-set otomatis).
...
export const LANGUAGES = [
  ...
  // — 80 bahasa tambahan (fallback ke Inggris hingga kamus diisi) —
...
// Set kode bahasa RTL untuk akses cepat.
